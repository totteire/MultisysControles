<table id="tableau" class="tableau tablesorter">
	...
	<?php
		include('connect.php');
		$req="SELECT CONTROLE.ID,CONTROLE.NUM,CONTROLE.TYPE_CTRL,CONTROLE.DATE,LIEU,PDF_EDIT, NOM, DESIGNATION,MARQUE,TYPE FROM CONTROLE,CLIENT C,APPAREIL A WHERE C.ID=CONTROLE.ID_AVOIR AND A.ID=CONTROLE.ID_CONCERNER ORDER BY DATE DESC;";
		$nb=0;
